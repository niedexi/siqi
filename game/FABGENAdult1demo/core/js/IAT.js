let template = {
  ...
  catA: {
    ...
    datalabel: "M",
    itemtype: "txt",
    items: ["male", "man", "boy", "he", "him"],
  },
  catB: {
    label: "Female",
    datalabel: "F",
    itemtype: "txt",
    items: ["female", "woman", "girl", "she", "her"],
  },
  cat1: {
    label: "Genius",
    datalabel: "G",
...
//Initialize program
function initialize() {
  document.title = "FABGENAdult1demo";
...
function instructionPage() {
  ...
  if (session == 7) {
    ...
    resulttext =
      "<div style='text-align:center;padding:20px'>Thank you for participating in our study! Your response has been recorded. </div> ";
...
function writeFile() {
  ...
  let final = JSON.stringify({
    category: "FABGENAdult1demo",
    folderID: "1T0a88S6nexoE73iWxSsoCEiZi_fS1R2o",
    name: ID,
    data: dataArray,
  });
